...
export async function setupTwoFactor(): Promise<TwoFactorSetupResponse> {
  try {
    ...
    throw createErrorWithCause('Failed to setup two-factor authentication', error);
  }
}
...
export async function verifyTwoFactor(code: string): Promise<void> {
  try {
    ...
    throw createErrorWithCause('Invalid verification code', error);
  }
}
...
export async function disableTwoFactor(password: string, code: string): Promise<void> {
  try {
    ...
    throw createErrorWithCause('Failed to disable two-factor authentication', error);
  }
}
...
export async function getTwoFactorStatus(): Promise<TwoFactorStatus> {
  try {
    ...
    throw createErrorWithCause('Failed to get two-factor status', error);
  }
}
...
export async function regenerateBackupCodes(code: string): Promise<string[]> {
  try {
    ...
    throw createErrorWithCause('Failed to regenerate backup codes', error);
  }
}
...
export async function requestEmergencyDisable(email: string): Promise<void> {
  try {
    ...
    throw createErrorWithCause('Failed to request emergency disable', error);
  }
}
...
export async function confirmEmergencyDisable(token: string): Promise<void> {
  try {
    ...
    throw createErrorWithCause('Invalid or expired token', error);
  }
}
